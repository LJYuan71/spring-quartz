package tk.ljyuan71.quartz.controller;
...
import tk.ljyuan71.quartz.entity.JobEntity;
import tk.ljyuan71.quartz.service.QuartzService;
...
public class QuartzController {
	...
	@Resource(name="schedulerFactoryBean1")
	...
	public String add(HttpServletRequest request,HttpServletResponse response) throws SchedulerException, ClassNotFoundException {
		...
		try {
			...
			request.setAttribute("message","cron表达式有误，不能被解析！");
